...
var DEFAULT_VARIABLE_FILTERS = ['escape'].map(JSON.stringify);
...
variableTag.compileTag = createPrintTagCompiler(DEFAULT_VARIABLE_FILTERS);
htmlTag.compileTag = createPrintTagCompiler(DEFAULT_HTML_FILTERS);
